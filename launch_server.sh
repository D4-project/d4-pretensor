...
redis-cli -h localhost -p 6502 -n 0 GRAPH.QUERY pretensor "CALL db.idx.fulltext.createNodeIndex('Command', 'content')"
redis-cli -h localhost -p 6502 -n 0 GRAPH.QUERY pretensor "CALL db.idx.fulltext.createNodeIndex('Binary', 'binname')"
