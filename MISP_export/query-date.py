...
for i in range(delta.days + 1):
    ...
    # Add Bots
    bots = redis_graph.query(getBotsForDate(strdate))
    ...
    for bot in bots.result_set:
        ...
        attributeAsDict = [{'node-ip': {'value': bot[0], 'type': 'ip-dst'}},
                           {'node-user': {'value': bot[1], 'type': 'text', 'to_ids': False,
                                          'disable_correlation': True}},
                           {'node-hostname': {'value': bot[2], 'type': 'text', 'disable_correlation': True}},
                           {'first-seen': {'value': record_datetimefs, 'type': 'datetime', 'to_ids': False,
                                           'disable_correlation': True}},
                           {'last-seen': {'value': record_datetimels, 'type': 'datetime', 'to_ids': False,
                                          'disable_correlation': True}},
                           {'node-arch': {'value': bot[5], 'type': 'text', 'to_ids': False,
                                          'disable_correlation': True}}]
